...
import { isTruthy, isTruthyCustomParamValue, logDev, testId } from '@jwplayer/ott-common/src/utils/common';
import { formatConsents, formatConsentsFromValues, formatConsentsToRegisterFields, formatConsentValues } from '@jwplayer/ott-common/src/utils/collection';
