...
import type { ForgotPasswordFormData } from '@jwplayer/ott-common/types/account';
...
import { addQueryParam, removeQueryParam } from '@jwplayer/ott-common/src/utils/location';
