...
import type { LanguageDefinition } from '@jwp/ott-common-next/types/i18n';
import { filterSupportedLanguages } from '@jwp/ott-common-next/src/utils/i18n';
...
const initI18n = async () => {
  const enabledLanguages = process.env.APP_ENABLED_LANGUAGES?.split(',') || ['en'];
  const defaultLanguage = process.env.APP_DEFAULT_LANGUAGE || 'en';
