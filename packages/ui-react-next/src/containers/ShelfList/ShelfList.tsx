...
import type { Content } from '@jwp/ott-common-next/types/config';
...
import { mediaURL, slugify } from '@jwp/ott-common-next/src/utils/urlFormatting';
...
import { PersonalShelf, SHELF_LAYOUT_TYPE, PLAYLIST_LIMIT_MAX } from '@jwp/ott-common-next/src/constants';
import usePlaylists from '@jwp/ott-hooks-react-next/src/usePlaylists';
