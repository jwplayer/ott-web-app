...
import type { CustomFormField } from '@jwp/ott-common-next/types/account';
...
import { isTruthy, isTruthyCustomParamValue, testId } from '@jwp/ott-common-next/src/utils/common';
import { logError } from '@jwp/ott-common-next/src/logger';
import { formatConsents, formatConsentsFromValues, formatConsentsToRegisterFields, formatConsentValues } from '@jwp/ott-common-next/src/utils/collection';
