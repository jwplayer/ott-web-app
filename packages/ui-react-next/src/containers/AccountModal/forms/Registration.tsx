...
import type { RegistrationFormData } from '@jwp/ott-common-next/types/account';
...
import { checkConsentsFromValues, extractConsentValues, formatConsentsFromValues } from '@jwp/ott-common-next/src/utils/collection';
import useSocialLoginUrls from '@jwp/ott-hooks-react-next/src/useSocialLoginUrls';
import useForm from '@jwp/ott-hooks-react-next/src/useForm';
import { modalURLFromLocation, modalURLFromWindowLocation } from '@jwp/ott-ui-react-next/src/utils/location';
