...
import type { EpgProgram } from '@jwplayer/ott-common/types/epg';
import { programIsFullyWatchable, programIsLive, programIsVod } from '@jwplayer/ott-common/src/utils/epg';
