...
import type { CaptureCustomAnswer, CleengCaptureQuestionField, PersonalDetailsFormData } from '@jwp/ott-common-next/types/account';
...
import { type UseFormOnSubmitHandler } from '@jwp/ott-hooks-react-next/src/useForm';
import useOffers from '@jwp/ott-hooks-react-next/src/useOffers';
