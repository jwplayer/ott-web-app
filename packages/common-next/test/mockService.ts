...
vi.mock('@jwp/ott-common-next/src/modules/container', async () => {
  const actual = (await vi.importActual('@jwp/ott-common-next/src/modules/container')) as Record<string, unknown>;
