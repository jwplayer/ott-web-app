...
Scenario('I can see poster images for the `All courses` shelf', async ({ I }) => {
  ...
  await I.seeCardImageSrc('Primitive Animals', ShelfId.allCourses, 'https://cdn.jwplayer.com/v2/media/oXGyKQ97/poster.jpg?width=320');
  await I.seeCardImageSrc('Fantasy Vehicle Creation', ShelfId.allCourses, 'https://cdn.jwplayer.com/v2/media/lsFXY5xn/poster.jpg?width=320');
});
