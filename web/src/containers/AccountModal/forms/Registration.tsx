...
import type { RegistrationFormData } from '@jwplayer/ott-common/types/account';
...
import { checkConsentsFromValues, extractConsentValues } from '@jwplayer/ott-common/src/utils/collection';
