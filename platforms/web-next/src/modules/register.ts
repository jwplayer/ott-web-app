import '@jwp/ott-common-next/src/modules/register';
import { container } from '@jwp/ott-common-next/src/modules/container';
import StorageService from '@jwp/ott-common-next/src/services/StorageService';
import { BROADCAST_CHANNEL, GET_CUSTOMER_IP } from '@jwp/ott-common-next/src/modules/types';
import type { GetCustomerIP } from '@jwp/ott-common-next/types/get-customer-ip';
...
import { getOverrideIP } from '../utils/ip';
 ...
 * ```
 */
container.bind<LogTransporter>(LogTransporter).toDynamicValue(() => new ConsoleTransporter(process.env.DEV ? LogLevel.DEBUG : LogLevel.ERROR));
 ...
 * import { container as uiComponentContainer } from '@jwp/ott-ui-react-next/src/modules/container';
 *
