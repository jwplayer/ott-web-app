...
import type { EpgChannel, EpgProgram } from '@jwp/ott-common-next/types/epg';
import { getModule } from '@jwp/ott-common-next/src/modules/container';
import { getLiveProgram, programIsLive } from '@jwp/ott-common-next/src/utils/epg';
import { LIVE_CHANNELS_REFETCH_INTERVAL } from '@jwp/ott-common-next/src/constants';
import EpgController from '@jwp/ott-common-next/src/controllers/EpgController';
