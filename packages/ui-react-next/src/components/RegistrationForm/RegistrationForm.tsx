...
import type { CustomFormField, RegistrationFormData } from '@jwp/ott-common-next/types/account';
...
import { useCookieConsent } from '@jwp/ott-ui-react-next/src/hooks/useCookieConsent';
  ...
  return (
    <form onSubmit={onSubmit} data-testid={testId('registration-form')} noValidate>
      ...
      <p className={styles.bottom}>
        {t('registration.already_account')} <Link href={modalURLFromLocation(location, 'login')}>{t('login.sign_in')}</Link>
      </p>
