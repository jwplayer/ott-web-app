...
import type { Offer, ChooseOfferFormData } from '@jwp/ott-common-next/types/checkout';
import { useConfigStore } from '@jwp/ott-common-next/src/stores/ConfigStore';
import { getOfferPrice, isSVODOffer } from '@jwp/ott-common-next/src/utils/offers';
