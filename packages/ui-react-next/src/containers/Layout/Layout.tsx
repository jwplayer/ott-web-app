...
import { unicodeToChar } from '@jwp/ott-common-next/src/utils/common';
import { determinePath } from '@jwp/ott-common-next/src/utils/urlFormatting';
import env from '@jwp/ott-common-next/src/env';
import { useUIStore } from '@jwp/ott-common-next/src/stores/UIStore';
...
const Layout = () => {
  ...
  const containerProps = { inert: sideBarOpen || cookieWallOpen ? true : undefined }; // inert is not yet officially supported in react
