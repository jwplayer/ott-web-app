...
export type UpdatePaymentWithPayPalPayload = Omit<PaymentWithPayPalPayload, 'order'> & { paymentMethodId: number };
...
export type AddAdyenPaymentDetailsResponse = Omit<PaymentDetail, 'customerId'> | AdyenAction;
...
export type GetEntitledPlans = PromiseRequest<{ siteId: string }, PlansResponse | undefined>;
