...
import type { EpgProgram } from '@jwp/ott-common-next/types/epg';
import { programIsFullyWatchable, programIsLive, programIsVod } from '@jwp/ott-common-next/src/utils/epg';
