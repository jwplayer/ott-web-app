...
import type { ChooseOfferFormData, OfferType } from '@jwplayer/ott-common/types/account';
import type { FormErrors } from '@jwplayer/ott-common/types/form';
...
import { getOfferPrice, isSVODOffer } from '@jwplayer/ott-common/src/utils/subscription';
